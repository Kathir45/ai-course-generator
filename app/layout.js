...
import "./globals.css";
import { ClerkProvider, GoogleOneTap, RedirectToSignIn, RedirectToSignUp } from "@clerk/nextjs";
...
export const metadata = {
  ...
  author: "Hari Prasad", // Your name or organization
  openGraph: {
    ...
    url: "http://ai-course-generator-aayx.vercel.app/", // Replace with your actual URL
...
export default function RootLayout({ children }) {
  return (
    ...
    <ClerkProvider>
    {/* <RedirectToSignIn fallbackRedirectUrl="http://localhost:3000/dashboard" />
    <RedirectToSignUp fallbackRedirectUrl="http://localhost:3000/dashboard" /> */}
    <Head>
          {/* SEO Metadata */}
